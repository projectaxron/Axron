...
void StatisticsPage::updateStatistics()
{
    ...
    {
        phase = "FRESH POW (POS Starts Block 12000)";
    }
    ...
    {
		subsidy = "1000 AXR per block";
    }
	else if(pindexBest->nHeight < 101)
    {
		subsidy = "0 AXR per block";
    }
	else if(pindexBest->nHeight < 12000)
    {
		subsidy = "150 AXR per block";
    }
    ...
    {
        ui->volumeBox->setText("<b><font color=\"#ebbcff\">" + qVolume + " AXR" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " AXR" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " AXR");
    }
