...
unsigned int nTargetSpacing     = 80;               // 60 seconds
...
const string strMessageMagic = "Axron Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Axron", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Axron 8/21/14";
        CTransaction txNew;
        txNew.nTime = 1408655848;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1408655848;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
		block.nNonce   = 1155606262;
		if(fTestNet)
        {
            block.nNonce   = 0;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x70793862bdb11e3cd5f876d61f9eac0afb10458ee4535cdbf481eb504d07d9d0"));
        block.print();
